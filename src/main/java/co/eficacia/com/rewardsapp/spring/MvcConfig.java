...
import co.eficacia.com.rewardsapp.validation.EmailValidator;
import co.eficacia.com.rewardsapp.validation.PasswordMatchesValidator;
...
@Configuration
@ComponentScan(basePackages = { "co.eficacia.com.web" })
@EnableWebMvc
